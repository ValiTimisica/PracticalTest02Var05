...
public class PracticalTest02Var05MainActivity extends AppCompatActivity {
    ...
    private EditText cityEditText1 = null;

    private Button getWeatherForecastButton = null;
    private Button getWeatherForecastButton1 = null;
    ...
    private class GetWeatherForecastButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            String city1 = cityEditText1.getText().toString();
            ...
            clientThread = new ClientThread(
                    clientAddress, Integer.parseInt(clientPort), city, city1, weatherForecastTextView
            );
            clientThread.start();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cityEditText1 = (EditText)findViewById(R.id.city_edit_text1);
        ...
        getWeatherForecastButton1 = (Button)findViewById(R.id.get_weather_forecast_button1);
        getWeatherForecastButton1.setOnClickListener(getWeatherForecastButtonClickListener);
        //setOnClickListener
